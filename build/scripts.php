 ...
 *                                    Default 'false'.
 */
function jetpack_boost_override_script( $scripts, $handle, $src, $deps = array(), $ver = false, $in_footer = false ) {
 ...
 */
function jetpack_boost_register_package_scripts( $scripts ) {
...
add_action( 'wp_default_scripts', 'jetpack_boost_register_package_scripts' );
