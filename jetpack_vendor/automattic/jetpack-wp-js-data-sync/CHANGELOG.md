...
### Changed
- Remove documentation references to deprecated svelte-data-sync-client package.
...
[0.6.5-alpha]: https://github.com/Automattic/jetpack-wp-js-data-sync/compare/v0.6.4...v0.6.5-alpha
