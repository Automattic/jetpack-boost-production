...
class ComposerAutoloaderInitb1e77e6231d50e7663f84529b6a3dfda_jetpack_boostⓥ1_3_1
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitb1e77e6231d50e7663f84529b6a3dfda_jetpack_boostⓥ1_3_1::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequireb1e77e6231d50e7663f84529b6a3dfda_jetpack_boostⓥ1_3_1($fileIdentifier, $file);
        }
...
function composerRequireb1e77e6231d50e7663f84529b6a3dfda_jetpack_boostⓥ1_3_1($fileIdentifier, $file)
{
